...
| This FAQ is to answer some common questions about two-step verification for organizations planning to implement it for their team's use of Google Apps. |
   ...
   * [How is 2-Step different than Two-Factor Authentication (2FA)?](#how-is-2-step-different-than-two-factor-authentication-(2fa)?)
   ...
   * [I already have 2-Step, but I did not use a One Time Password app for my authentication. How can I change the authentication method?](#i-already-have-2-step,-but-i-did-not-use-a-one-time-password-app-for-authentication.-how-can-i-change-the-authentication-method?)
   * [How often will I have to use my second step for authentication?](#how-often-will-i-have-to-use-my-second-step-for-authentication?)
   * [What happens if I lose the device with the One Time Password app or my security key?](#what-happens-if-i-lose-the-device-with-the-one-time-password-app-or-my-security-key?)
   * [What if I have no data or phone connectivity?](#what-if-i-am-travelling?)
   * [What if I am travelling?](#what-if-i-am-travelling?)
   * [What else does Google do with the phone number?](#what-else-does-google-do-with-the-phone-number?)
   * [How do I remove trusted devices?](#how-do-i-remove-trusted-devices?)
   * [Out of curiosity, what are the other options?](#out-of-curiosity,-what-are-the-other-options?)
   * [What other accounts can I protect with 2-Step?](#great!-my-access-now-google-account-is-more-secure.-what-else-can-i-protect?)
   * [More Information](#where-can-i-find-more-information?)
...
How is 2-Step different than Two-Factor Authentication (2FA)? 
--------------------------------------------------------------
...
----------------
   ...
   4. After receiving and verifying your account with the first code, you may choose to trust the computer you are using - assuming only you have access to it. This will prevent your having to [complete the 2-Step process every time](#how-often-will-i-have-to-use-my-second-step-for-authentication?) you log in.
   
   5. Review your [settings](https://accounts.google.com/b/1/SmsAuthSettings#devices) and under “Verification Codes” choose a One Time Password app as the “Primary Way You Receive Codes”. Please read [Which Authentication method should I choose?](#which-authentication-method-should-i-choose?) for the rationale.  
...
I already have 2-Step, but I did not use a One Time Password app for authentication. How can I change the authentication method?
---------------------------------------------------------------------------------------------------------------------------------
...
How often will I have to use my second step for authentication?
----------------------------------------------------------------
...
What happens if I lose the device with the One Time Password app or my security key?
------------------------------------------------------------------------------------
...
What if I have no data or phone connectivity?
----------------------------------------------
...
What else does Google do with the phone number?
------------------------------------------------
